 ...
 * global.greeting
 * --------------------------------------------------------------------------
 * { online: '上线了。', die: '上线了，但又没上。', hello: '大家好。', new: '向旅行者问好。', newArknights: '向博士问好。' }
 * --------------------------------------------------------------------------
 * ../../config/greeting.yml
 * --------------------------------------------------------------------------
 * online: 上线了。
...
global.innerAuthName = { reply: "响应消息", mysNews: "米游社新闻推送", akNews: "明日方舟新闻推送" };

global.all = {};
global.artifacts = {};
global.authority = {
  setting: {
    ak_news_auth: [global.innerAuthName.akNews],
    artifact_auth: ["artifacts", "strengthen", "dungeons"],
    character_overview_auth: ["info", "material", "weapon", "talent", "weekly"],
    feedback_auth: ["feedback"],
    fun_auth: ["menu", "prophecy", "roll"],
