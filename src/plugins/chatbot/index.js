...
async function Plugin(Message, bot) {
  ...
  //   await bot.sendMessage(sendID, "2.6版本兑换码如下：", type);
  //   await bot.sendMessage(sendID, `VTKJVSXQKY8J`, type);
  //   await bot.sendMessage(sendID, `BAQNKLQEKWVE`, type);
  //   await bot.sendMessage(sendID, `DT33UTWQKZR6`, type);
  //   return;
  // }
